...
C ----------------------------------------------------------------
C
C cell or ECM or adhesion layer or chromatin
C
      IF (TAG.EQ.2) THEN
          GO TO 555         ! ECM
...
C  
      Rho0 = Rho0I + 0.4D0 * STATEV(10+4*NTENS+4) * Rho0I
...
C total free energy
      ...
      STATEV(77) = Utotal
C
C energy contributions in the paper
      STATEV(78) = Ustrain + Uext + Uactin          ! mechanical energy
      STATEV(79) = Umotchem + Umechfeed             ! chemical energy
      STATEV(80) = Umotor                           ! motor-work
C
C    
C ----------------------------------------------------------------
C ----------------------------------------------------------------
